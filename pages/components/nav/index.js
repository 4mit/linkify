      ...
      <div>
        {navConfig.map((n, i) => {
          return (
            <a
              key={i}
              class="shadow cursor-pointer w-full font-thin uppercase text-gray-500  flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500"
              href={n.link}
            >
